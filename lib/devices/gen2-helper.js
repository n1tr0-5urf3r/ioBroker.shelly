...
function addBluTrvDevice(deviceObj, sensorId) {
    deviceObj[`BluTRV.BluTRV${sensorId}.TargetTemperature`] = {
        mqtt: {
    ...
    deviceObj[`BluTRV.BluTRV${sensorId}.CurrentTemperature`] = {
        mqtt: {
            http_publish: `/rpc/BluTrv.GetStatus?id=${sensorId}`,
    ...
    deviceObj[`BluTRV.BluTRV${sensorId}.ValvePosition`] = {
        mqtt: {
            http_publish: `/rpc/BluTrv.GetStatus?id=${sensorId}`,
    ...
    deviceObj[`BluTRV.BluTRV${sensorId}.Battery`] = {
        mqtt: {
            http_publish: `/rpc/BluTrv.GetStatus?id=${sensorId}`,
    ...
    deviceObj[`BluTRV.BluTRV${sensorId}.Errors`] = {
        mqtt: {
            http_publish: `/rpc/BluTrv.GetStatus?id=${sensorId}`,
    ...
    deviceObj[`BluTRV.BluTRV${sensorId}.CheckForUpdates`] = {
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value, self) => JSON.stringify({
                id: self.getNextMsgId(),
    ...
    deviceObj[`BluTRV.BluTRV${sensorId}.UpdateFirmware`] = {
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value, self) => JSON.stringify({
                id: self.getNextMsgId(),
    ...
    deviceObj[`BluTRV`] = {
        mqtt: {
            ...
            http_publish_funct: (value, self) => {
                ...
                self.adapter.log.warn(JSON.stringify(valueObj, null, 2));

                for (const c of valueObj.components) {
                    self.adapter.log.warn(JSON.stringify(c, null, 2));
